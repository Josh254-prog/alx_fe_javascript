 ...
 * This function directly influences the content shown in the 'quoteDisplay' element.
 */
function filterQuotes() {
  ...
  showRandomQuote(); // Display a random quote from the filtered set, which updates 'quoteDisplay'
}
 ...
 */
async function createAddQuoteForm() { // Renamed addQuote to createAddQuoteForm
